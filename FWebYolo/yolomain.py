...
def yolo_ser(im,
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            ...
            out_box.append([x, y, w, h])
            out_scores.append(confidences[i])
            out_lab.append(LABELS[classIDs[i]])



    return out_box, out_scores, out_lab
...
if __name__ == '__main__':
    ...
    im = cv2.imread('./static/images/test4.jpg')
    out_boxes, out_scores, out_classes = yolo_ser(im)
    print(out_boxes)
    print(out_scores)
    print(out_classes)


    # pathIn = './test_imgs/0140.jpg'
    # pathOut = './result_imgs/0140.jpg'
    # yolo_detect(pathIn, pathOut)