"""
Retrain the YOLO model for your own dataset. Yolo_Mobile body is defined in yolo3/model_Mobilenet.
yolo_body was reconstructed by MobileNet structure, but tiny_yolo_body is still what it is.
So if you want to use yolo_tiny_MobileNet, reconstruct it youself! Happy deep learning!
"""
...
def create_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=2,
            weights_path='model_data/ep003-loss58.622-val_loss59.096.h5'):
