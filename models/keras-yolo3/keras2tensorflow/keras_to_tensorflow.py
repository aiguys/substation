...
def writePB2tensorborad(bpDir,output):
    """
    模型写入tensorboard文件夹方便查看
    :param bpDir:
    :param output:
    :return:
    """
    ...
    summaryWriter = tf.summary.FileWriter(output, graph)

if __name__ == "__main__":
    writePB2tensorborad(bpDir='/Users/henry/Documents/application/substation/models/keras-yolo_v3/model_data/yolo33.pb',
                        output='/Users/henry/Documents/application/substation/models/keras-yolo_v3/model_data/log3/')
    app.run(main)
