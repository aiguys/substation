...
class YOLO(object):
    _defaults = {
        "model_path": 'model_data\\ep036-loss40.467-val_loss40.985.h5', # 000: ep062-loss21.860-val_loss17.623 001:ep034-loss23.645-val_loss17.370
        "anchors_path": 'cfg\\yolo_anchorskmeans.txt', # \t需要\\t进行转义
        "classes_path": 'cfg\hat_classes.txt',
        "score" : [0.1,0.3], # 0: person 1: hat, index same as class.txt file
        "iou" : 0.2,
