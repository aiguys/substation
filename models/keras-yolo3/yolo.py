...
class YOLO(object):
    _defaults = {
        "model_path": 'logs\\belt_hat\\yolov3-belt_hat-val_loss16.867.h5', # 000: ep062-loss21.860-val_loss17.623 001:ep034-loss23.645-val_loss17.370
        "anchors_path": 'logs\\belt_hat\\hat-beltclasses_yolo_anchors.txt', # \t需要\\t进行转义
        "classes_path": 'logs\\belt_hat\hat-beltclasses.txt',
        "score" : [0.2,0.4,0.25,0.2,0.2], # index same as class.txt file
        "iou" : 0.35,
    ...
    def detect_image(self, image,list_file): # add parameter 'list_file' here to test on all images and write the results down
        ...
        for i, c in reversed(list(enumerate(out_classes))):
           ...
           #  used for drawing rectangles on the image
